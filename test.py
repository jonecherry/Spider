                    ...
                    for ye in range(1,int(poiyeshu)+1):
                        ...
                        for poiblock in poiblocks:
                            ...
                            if r1 or r2:
                                ...
                                print '插入新POI... ...'
                                print '中文：' + poi_ch_name,'英文：' + poi_en_name, '本地语言名称:' + poi_en_name, '城市id:' + str(region_id),'城市:'+poi_region, '类型：' + str(tag_id), '评论数:' + str(comments_count),  '排名:' + str(poi_rank), '地址:' + poi_address, '电话:' + poi_telephone
